  ...
  return (
    <div className="font-sans text-gray-800 h-screen overflow-hidden">
      ...
      <div className="flex h-screen bg-gray-50">
        ...
        {/* Desktop sidebar */}
        {isMobile === false && (
          <aside className="flex flex-col w-64 flex-shrink-0 bg-white shadow-xl border-r border-gray-100">
        ...
        <div className="flex flex-col flex-1 min-w-0">
          ...
          {isMobile === true && (
            <header className="flex items-center justify-between bg-white border-b border-gray-100 px-4 py-3 shadow-sm flex-shrink-0">
              ...
              <span className="text-xs font-bold bg-red-100 text-red-600 px-2 py-0.5 rounded-full">Admin</span>
            </header>
          )}
  ...
  return (
    <>
      <div className="p-6 lg:p-8">
        ...
        <span className="inline-block mt-2 text-xs font-bold bg-red-100 text-red-600 px-2 py-0.5 rounded-full">
          Admin
        </span>
      </div>
      ...
      <div className="p-4 border-t border-gray-100">
        <button
          onClick={onLogout}
          className="w-full px-4 py-3 text-sm font-bold text-red-600 hover:bg-red-50 rounded-xl transition-all text-left"
        >
          Log Out
        </button>
      </div>
